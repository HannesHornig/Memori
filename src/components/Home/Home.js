...
const Home = () => (
    <div className="home">
        ...
        <div className="difficulty-container">
            <div className="homeLinkClass"> <Link to="/explanation/small" ><img src={memory} height ={height}></img>Kleines Memory</Link></div>
            <div className="homeLinkClass">  <Link to="/explanation/big"><img src={doubleMemory} height ={height}></img>Großes Memory</Link></div>
            <div className="homeLinkClass"> <Link to="/explanation/countries"><img src={"/pictures/Gurke.jpg"} height ={height}></img>Ländermemory</Link></div>
        </div>
    </div>
);
