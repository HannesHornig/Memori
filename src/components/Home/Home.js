...
const Home = () => (
    <div className="home">
        ...
        <div className="difficulty-container">
            <div className="homeLinkClass"> <Link to="/game/small" ><img src={memory} height ={height}></img>Kleines Memory</Link></div>
            <div className="homeLinkClass">  <Link to="/game/big"><img src={doubleMemory} height ={height}></img>Großes Memory</Link></div>
            <div className="homeLinkClass"> <Link to="/game/countries"><img src={"/pictures/Gurke.jpg"} height ={height}></img>Ländermemory</Link></div>
        </div>
    </div>
);
