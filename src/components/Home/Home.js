...
const Home = () => (
    <div className="home">
        ...
        <div className="difficulty-container">
            <div className="homeLinkClass"> <Link to="/game/easy" ><img src={memory} height ={height}></img>Spiel mit 15 Karten</Link></div>
            <div className="homeLinkClass">  <Link to="/game/hard"><img src={doubleMemory} height ={height}></img>Spiel mit allen 30 Karten</Link></div>
            <div className="homeLinkClass"> <Link to="/game/triples"><img src={gurke} height ={height}></img>Spiel mit den Früchten und ihren Ursprungsländern</Link></div>
        </div>
    </div>
);
