...
const App = () => (
<div className="app">
        <header><h1>Wandernde Früchte<img src={logo}></img></h1><Link to="/impressum" class="impressumClass">Impressum</Link><Link to="/lexicon" class="lexiconClass">Lexicon</Link></header>
